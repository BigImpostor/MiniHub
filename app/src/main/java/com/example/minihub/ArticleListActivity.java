...
import com.example.minihub.adapter.ArticleAdatper;
...
public class ArticleListActivity extends AppCompatActivity {
    ...
    private ArticleAdatper mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new ArticleAdatper(ArticleListActivity.this, articleLists);
        ...
        Disposable disposable = observable.observeOn(AndroidSchedulers.mainThread())
                .subscribeOn(Schedulers.io()).subscribeWith(new SimplifyObserver<Article>() {
                    ...
                    public void onNext(Article article) {
                        ...
                        totalPage = article.getData().getTotal();
                        if (totalPage == 1){
                            mAdapter.loadingState(BaseAdapter.STATE_COMPLETE);
                        }
